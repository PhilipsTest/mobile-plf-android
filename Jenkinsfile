...
def DeployingJavaDocs() {
    ...
    def shellcommand = '''#!/bin/bash -l
        ...
        curl -L -u 320049003:AP8vGdZe9YmJVf1t3np14Pai7hn -X PUT $ARTIFACTORY_URL/$ARTIFACTORY_REPO/com/philips/cdp/jump/$platformVersion/ -T ./Source/usr/Documents/External/jump-api.zip

...
enum class ECSErrorType(var resourceID: Int, var errorCode: Int) {
    ...
    ECSPIL_MISSING_PARAMETER_language(R.string.ECSPIL_MISSING_PARAMETER_language, 6003),
    ECSPIL_NOT_FOUND_productId(R.string.ECSPIL_NOT_FOUND_productId, 6004),
    ECSPIL_MISSING_API_VERSION(R.string.ECSPIL_MISSING_API_VERSION, 6005),
    ECSPIL_INVALID_API_VERSION(R.string.ECSPIL_MISSING_API_VERSION, 6006),
    ECSPIL_MISSING_API_KEY(R.string.ECSPIL_MISSING_API_KEY, 6007),
    ECSPIL_INVALID_API_KEY(R.string.ECSPIL_MISSING_API_KEY, 6008),
    ECSPIL_INVALID_PRODUCT_SEARCH_LIMIT(R.string.ECSPIL_INVALID_PRODUCT_SEARCH_LIMIT, 6009),
    ECSPIL_NOT_ACCEPTABLE(R.string.ECSPIL_NOT_ACCEPTABLE, 6010  ),

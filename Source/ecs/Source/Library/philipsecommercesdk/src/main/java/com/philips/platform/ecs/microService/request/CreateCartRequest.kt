...
class CreateCartRequest(private val ctn: String, private val quantity: Int,private val ecsCallback: ECSCallback<ECSShoppingCart, ECSError>)  : ECSJsonRequest(ecsCallback){
    ...
    override fun getHeader(): MutableMap<String, String>? {
        ...
        val authBearer:String = "bearer "+ "Auth Token TBD"
    ...
    override fun onResponse(response: JSONObject) {
        val shoppingCart = response.getData(ECSShoppingCart::class.java)

 ...
 */
class ProductFeaturesRequest : PrxRequest {
    ...
    override fun getResponseData(jsonObject: JSONObject?): ResponseData? {
        return FeaturesModel().parseJsonResponseData(jsonObject)
    }

    companion object {
        private const val PRXDisclaimerDataServiceID = "prxclient.features"
    }
}